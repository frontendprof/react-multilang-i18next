...
function App() {
  const getCurrentLangCode=cookies.get("i18next") || "en";
  const currentLang=languages.find(l=>l.code===getCurrentLangCode)
              ...
              <li key={country_code}>
                ...
                >
                  <span className={`flag-icon flag-icon-${country_code} mx-2`}
                    style={{ opacity:code===getCurrentLangCode?0.4:1 }}
                  ></span>
                  {name}
                  </button>
                </li>
